...
parser.add_argument("--template", help="name of template file", type=str, default="DESeq2.R")
...
parser.add_argument("--prefix", help="prefix for output files", type=str, default="output_")
parser.add_argument("--datafile", help="name of data file containing gene count data", type=str, default="gene_cnt_matrix.tab")
