...
```{r make pca plot caption, echo=FALSE}
...
## Plot PCA Reslts
```{r plot PCA results, echo=FALSE, message=FALSE, fig.cap=pcaption}
...
```{r PCA plot svg, echo=FALSE, message=FALSE}
...
```{r create volcano plots, echo=FALSE}
